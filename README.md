...
| 维度 | IC_5d | IC_20d | IC_60d | 单独净夏普 | 年换手 | 结论 |
|---|---|---|---|---|---|---|
| 动量与持仓 | -0.024 | **-0.049** | -0.034 | **-0.45** | **25.0** | 否决 |
| 宏观流动性 | +0.085 | **+0.187** | **+0.209** | **+0.34** | 3.1 | 保留 |
| 相对估值 | -0.003 | -0.028 | -0.054 | -0.19 | 11.8 | 否决 |

动量维度不只是无效——年换手 25 倍、单独夏普 -0.45，它在**持续烧钱**。
三维等权合成时，它把宏观维度的 +0.187 稀释到 **-0.045**，
...
**其他已知局限**：方向先验固定，未做 regime 切换（"宽松利好成长"在衰退期会翻转）；
